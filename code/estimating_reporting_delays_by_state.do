clear all
capture log close
log using "..\logs\estimating_reporting_delays_by_state.txt", text replace

use "..\data\past_reports\9 May 2020 cdc_deaths.dta"
//drop if _n <=228 // these observations appear to be corrupted; see readme file in this folder for explantion
drop _all
